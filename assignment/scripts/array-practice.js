...
let favoriteFoods = ["steak", "pho", "seafood", "burger"];
console.log("Yummy foods I like are: ", favoriteFoods);
...
console.log("The number of Yummy foods I like is: " , numberOfFoods);
...
console.log("The animals include: " , animalArray);
...
let dessert = "pecan pie";
favoriteFoods.push(dessert); 
console.log("Added new dessert to end, ", favoriteFoods); 
...
let entree = "grilled fish samon";
favoriteFoods.unshift(entree);
console.log(`Added new entree to the begining: ${favoriteFoods}`);
...
console.log("The colors now only contain:" , colors);
console.log("The last color contains:" , lastColor); 
...
console.log("The remaining colors are now" , colors);
...
gems[1] = "Tourmaline";
console.log("Updated the gems array:" , gems)

// 5.b (STRETCH) TODO: Sort your gems array in reverse alphabetical order.
//     Please console.log the sorted array. 
gems.sort().reverse();
console.log("Gems array are now in reverse alphabetical order:" , gems);
...
console.log("Colorful gems array is here:" , colorfulGems);
